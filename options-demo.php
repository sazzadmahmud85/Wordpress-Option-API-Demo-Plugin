<?php
/*
Plugin Name: WordPress Options Demo
Plugin URI:
...
add_action( 'wp_ajax_options_display_result', function () {
    ...
    if ( wp_verify_nonce( $_POST['nonce'], 'options_display_result' ) ) {
        ...
        if('add-option' == $task){
            ...
            $key = 'od-array-json';
            $value = json_encode(['country' => 'Bangladesh', 'capital' => 'Dhaka']);
            echo "Result = ".add_option($key, $value)."<br>";
            ...
            $json_key = 'od-array-json';
            $result = json_decode(get_option($json_key), true);
            print_r($result);
            ...
            $key = 'od-new-array';
            $value = ['country' => 'Bangladesh', 'capital' => 'Dhaka'];
            $new_value = ['country' => 'Peru', 'capital' => 'Lima'];
            echo "Result = ".update_option($key, $value)."<br>";
            ...
            $import_data = '{"od-country":"BANGLADESHis a beautiful country","od-capital":"Dhaka","od-array":{"country":"Bangladesh","capital":"Dhaka"},"od-new-array":{"country":"Peru","capital":"Lima"},"od-array-json":null}';
...
add_filter('option_od-country', function($value){
    return strtoupper($value)."is a beautiful country";
});
